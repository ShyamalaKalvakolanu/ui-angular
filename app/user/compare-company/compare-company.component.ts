...
export class CompareCompanyComponent implements OnInit {
  ...
  constructor(private hcs: HighchartsService,private formBuilder: FormBuilder,private router:Router,private companyserviceservice:CompanyserviceService,private sectorsserviceservice: SectorsserviceService,private stockpriceservice:StockpriceserviceService) { }
  companyList: Company[];
